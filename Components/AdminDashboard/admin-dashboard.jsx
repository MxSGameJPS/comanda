...
export default function AdminDashboard() {
  ...
  return <main className={styles.page}><aside className={styles.sidebar}><div className={styles.brand}><span>C</span><strong>Comanda</strong></div><nav><a className={styles.active} href="#resumo">Resumo</a><a href="#financeiro">Financeiro</a><a href="#funcionarios">Funcionários</a><a href="#auditoria">Auditoria</a></nav><Link href="/">← Portal</Link></aside>
    <section className={styles.content}><header className={styles.header}><div><span className={styles.eyebrow}>Gestão</span><h1>Painel administrativo</h1><p>Visão operacional e financeira do restaurante em tempo quase real.</p></div><div className={styles.date}>{today} · Hoje</div></header>
