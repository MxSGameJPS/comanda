...
export default function CashierDashboard() {
  ...
  async function sendOrder(sessionId, items) {
    const response = await fetch("/api/staff/cashier/orders", {
      method: "POST",
