...
import { restSelect, restUpdate, storageUpload } from "@/lib/supabase/server";
...
export async function POST(request, { params }) {
  try {
    ...
    const uploaded = await storageUpload("product-images", objectPath, bytes, { contentType: file.type });
